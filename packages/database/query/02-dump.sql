...
-- Schema blockmetrics
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `blockmetrics` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;
USE `blockmetrics` ;

-- -----------------------------------------------------
-- Table `blockmetrics`.`blockchain`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `blockmetrics`.`gas_price_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `blockmetrics`.`gas_price_history` (
  `id` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `blockmetrics`.`node_count_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `blockmetrics`.`node_count_history` (
  `id` VARCHAR(255) NOT NULL,
  `blockchain_id` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `blockmetrics`.`blockchain_has_account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `blockmetrics`.`blockchain_has_account` (
  `blockchain_id` VARCHAR(255) NOT NULL,
  ...
  CONSTRAINT `fk_blockchain_has_account_account1`
    ...
    REFERENCES `blockmetrics`.`account` (`public_address`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
INSERT INTO `blockchain` (`id`, `name`, `logoUrl`, `note`, `power_consumption`, `node_count`, `hashrate`,`difficulty`, `time_between_blocks`, `token_count`, `transaction_count`, `gas_price`, `description_en`, `created_at`, `updated_at`) VALUES
('0bb6df38-231e-47d3-b427-88d16a65580e', 'Binance SC', '/assets/img/binance-smart-chain.svg', NULL, 0, NULL, 0, NULL, NULL, 0, 0, NULL, NULL, '2022-04-19 11:47:09', '2022-04-19 11:47:09'),
('1daa2a79-98cc-49a5-970a-0ad620a8b0d9', 'Bitcoin', '/assets/img/bitcoin.svg', NULL, 0, NULL, 0, NULL, NULL, 1, 0, NULL, NULL, '2022-04-19 11:48:19', '2022-04-19 11:48:19'),
('387123e4-6a73-44aa-b57e-79b5ed1246d4', 'Ethereum', '/assets/img/ethereum.svg', NULL, 0, NULL, 0, NULL, NULL, 0, 0, NULL, NULL, '2022-04-19 11:46:20', '2022-04-19 11:46:20'),
('4df0b4ad-2165-4543-a74b-7cdf46f9c5e3', 'Polygon', '/assets/img/polygon-pos.svg', NULL, 0, NULL, 0, NULL, NULL, 0, 0, NULL, NULL, '2022-04-19 11:47:32', '2022-04-19 11:47:32'),
('7fc003e2-680f-4e69-9741-b00c18d2e6dc', 'Avalanche', '/assets/img/avalanche.svg', NULL, 0, NULL, 0, NULL, NULL, 0, 0, NULL, NULL, '2022-04-19 11:50:53', '2022-04-19 11:50:53');
